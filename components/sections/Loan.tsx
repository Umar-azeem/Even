...
const loanTypes = [
  {
    ...
    description:
      "Traditional mortgage options with competitive rates for qualified buyers.",
    icon: Home,
    features: [
  ...
  },
  {
    ...
    title: "FHA Loans",
    description:
      "Government-backed loans designed for first-time homebuyers with lower credit requirements.",
    icon: Shield,
    features: [
...
const whyChoose = [
  {
    ...
    description:
      "No ghosting, no confusing updates. You'll know where your loan stands every step.",
    icon: CheckCircle,
  },
  {
    title: "Fast Response Times",
    description:
      "Questions get answered the same day because timing matters in real estate.",
    icon: Clock,
  },
  {
    title: "Tailored Strategy",
    description:
      "Your loan is built around your goals, budget, and future plans.",
    icon: FileCheck,
  },
  {
    title: "Local Expertise",
    description:
      "As a Bloomingdale resident, I understand our market and what local buyers face.",
    icon: Home,
  },
];
...
const steps = [
  {
    ...
    title: "Pre-Approval",
    description:
      "Get pre-approved to know exactly how much home you can afford.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Application",
    description:
      "Complete your application with guidance every step of the way.",
  },
  {
    number: "04",
    title: "Closing",
      ...
      <section className="relative   text-white py-16 sm:py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
            From first-time homebuyers to seasoned investors, I offer a wide
            range of mortgage solutions tailored to your unique needs.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Explore our comprehensive range of loan programs designed to meet
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link href="/contact">
                    <Button
                      variant="outline"
                      className="w-full border-[#04205D] text-[#04205D] hover:bg-[#04205D] hover:text-white transition-colors"
                    >
                      Learn More
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChoose.map((item, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-[#04205D] mb-2">
                  {item.title}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-blue-200 text-lg">
              Getting a mortgage doesn't have to be complicated. Here's how I
              make it easy.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            Whether you're buying your first home, refinancing, or investing in
            property, I'm here to help you find the right loan.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact">
