    ...
    <section id="vision" className="py-12 sm:py-16 lg:py-24 bg-white animate-in fade-in slide-in-from-bottom duration-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 text-[#04205D] text-base sm:text-lg leading-relaxed animate-in fade-in slide-in-from-bottom duration-700 delay-200">
          ...
          <p>
            Having seen how complex and overwhelming the lending process can be, my mission is clear: to provide a service where education, transparency, and personal attention are the foundation of every client relationship. I believe that a mortgage isn&apos;t just a loan—it&apos;s a stepping stone to a family&apos;s future.
          </p>
          <p>
            By combining modern lending tools with genuine, human-centered service, I ensure that every borrower feels informed, empowered, and fully supported from the initial application to the final signature.
          </p>
        </div>
      </div>
    </section>
